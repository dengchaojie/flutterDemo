...
class MovieDetail {
  ...
  MovieDetail(this.rating, this.originalTitle, this.images, this.year,
      this.comments, this.alt, this.id,
      this.title, this.pubdates, this.tags, this.durations, this.genres,
      this.trailers, this.casts, this.directors,
